...
import type { ITrainer, IScorecardMetric, TeamType, ExperienceLevel, CompensationType } from '@rmp/shared-types';
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setForm((p) => ({
                    ...
                    classConfig: ct === 'per_class' ? (p.classConfig || { tdsRate: 0.10 }) : undefined,
                  }));
                }}
              >
